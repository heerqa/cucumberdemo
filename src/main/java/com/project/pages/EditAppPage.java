...
public class EditAppPage {
	...
	static final Logger logger = Logger.getLogger(EditAppPage.class);
	WebDriver driver;
	...
	public String getPlateform(){
		String selectedOption=new Select(plateform).getFirstSelectedOption().getText();
		return selectedOption;
	}
	
	public String getOrientation(){
		String selectedOption=new Select(orientation).getFirstSelectedOption().getText();
		return selectedOption;
	}
